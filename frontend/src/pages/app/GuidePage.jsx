  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      ...
      <div className="card">
        ...
        <div className="muted">
          Дайте свой промокод друзьям или клиентам. Когда они зарегистрируются с ним и совершат покупку, вы получите
          <span className="accent-mint"> бонус</span>.
        </div>
        <div className="muted" style={{ marginTop: 6 }}>
          Новый пользователь получает приветственный бонус при регистрации, а ваше вознаграждение начисляется после подтверждения покупки.
        </div>
      </div>
